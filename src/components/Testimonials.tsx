...
const testimonials = [
  {
    id: 1,
    quote: "The post-partum program at Harmony helped me reconnect with my body and build strength gradually. The community of other mothers made all the difference in my recovery journey.",
    name: "Sarah Johnson",
  ...
  {
    id: 2,
    quote: "Completing the teacher training here transformed not just my practice but my entire perspective on wellness. The instructors create a perfect balance of challenge and support.",
    name: "Michael Chen",
  ...
  {
    id: 3,
    quote: "I've been attending daily classes for over a year now. The variety of styles and instructors ensures I'm always learning and growing, no matter how busy my schedule gets.",
    name: "Emma Rodriguez",
...
const Testimonials = () => {
  ...
  return (
    <section 
      className="py-20 md:py-32 bg-yoga-forest/5 overflow-hidden"
    >
                ...
                >
                  ...
                  <div className="flex items-center mt-8">
                    ...
                    <div className="text-left">
                      <h4 className="font-medium text-yoga-charcoal">{testimonial.name}</h4>
                      <p className="text-yoga-charcoal/70 text-sm">{testimonial.title}</p>
                    </div>
                  </div>
                </div>
              ))}
