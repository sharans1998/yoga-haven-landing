...
import { Baby, Book, Clock } from 'lucide-react';
      ...
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl font-display text-yoga-charcoal mb-6">
            Specialized Programs for <span className="italic">Your Journey</span>
          </h2>
          
          <p className="text-yoga-charcoal/80 text-lg leading-relaxed">
            We offer expertly designed programs to support your unique path toward wellness, 
            strength, and inner balance at every stage of life.
          </p>
        </div>
        
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <ServiceCard
            title="Post-Partum Fitness"
            description="Specialized classes designed for new mothers to rebuild strength, restore balance, and connect with a supportive community during this transformative time."
            icon={Baby}
            delay={1}
          ...
          <ServiceCard
            ...
            description="Comprehensive 200-hour and 300-hour programs that deepen your practice and prepare you to guide others with knowledge, compassion and confidence."
            icon={Book}
            delay={2}
          ...
          <ServiceCard
            ...
            description="A diverse schedule of classes for all levels, from gentle restorative sessions to challenging vinyasa flows, designed to fit your lifestyle."
            icon={Clock}
            delay={3}
