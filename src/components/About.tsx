...
const About = () => {
  ...
  return (
    <section id="about" className="py-20 md:py-32 bg-yoga-cream overflow-hidden">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-yoga-charcoal/80 text-lg mb-6 leading-relaxed">
              Founded with a vision of creating a nurturing space for transformation, Harmony Yoga Institute brings together the ancient wisdom of yoga with modern approaches to wellness.
            </p>
            
            <p className="text-yoga-charcoal/80 text-lg mb-8 leading-relaxed">
              Our studio is a home for practitioners of all levels—from beginners taking their first steps into yoga to experienced teachers deepening their practice and knowledge.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-10">
              <div className="bg-white/50 backdrop-blur-sm p-6 rounded-2xl border border-yoga-sand transition-transform hover:translate-y-[-5px]">
                <h3 className="font-display text-xl text-yoga-charcoal mb-2">Experienced Instructors</h3>
                <p className="text-yoga-charcoal/70">Our teachers bring decades of practice and specialized training to every class.</p>
              </div>
              
              <div className="bg-white/50 backdrop-blur-sm p-6 rounded-2xl border border-yoga-sand transition-transform hover:translate-y-[-5px]">
                <h3 className="font-display text-xl text-yoga-charcoal mb-2">Supportive Community</h3>
                <p className="text-yoga-charcoal/70">Join a welcoming group of practitioners on the journey toward wellness.</p>
              </div>
            </div>
          </div>
        </div>
